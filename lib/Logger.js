...
class Logger {
    ...
    constructor(category, mod) {
        this.context = Logger.createContext(category, mod)
     ...
     */
    static async setManager(manager) {
        if (this[MANAGER]) {
     ...
     */
    static createContext(context, mod) {
        if (typeof context === 'string')
            return this.createContext(new Context({ category: context }), mod)
        if (typeof context === 'object' && !(context instanceof Context))
            return this.createContext(new Context(context), mod)
